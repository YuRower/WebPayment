...
public class RedirectReplenishmentCompletedCommand extends Command {

	private static final Logger LOG = LogManager.getLogger(RedirectReplenishmentCompletedCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to replenish completed");

		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_PAYMENT_CONFIRMED);
	}

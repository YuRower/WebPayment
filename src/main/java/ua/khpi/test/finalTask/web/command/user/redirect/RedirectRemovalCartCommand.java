...
public class RedirectRemovalCartCommand extends Command {
	private static final Logger LOG = LogManager.getLogger(RedirectRemovalCartCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_CART_REMOVAL_CONFIRMED);
	}

...
public class RedirectNewPaymentCommand extends Command {
	
	private static final Logger LOG = LogManager.getLogger(RedirectNewPaymentCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to new payment page");

		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_NEW_PAYMENT);
	}

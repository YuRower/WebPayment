...
public class RedirectValidationCompletedCommand extends Command {

	private static final Logger LOG = LogManager.getLogger(RedirectValidationCompletedCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to validation completed page");

		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_VALIDATION_COMPLETED);
	}

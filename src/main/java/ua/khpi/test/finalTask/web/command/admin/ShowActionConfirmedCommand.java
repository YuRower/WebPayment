...
public class ShowActionConfirmedCommand extends Command {

	private static final Logger LOG = LogManager.getLogger(ShowActionConfirmedCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to action confirmed page");
		
		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_ADMINS_ACTION_CONFIRMED);
	}

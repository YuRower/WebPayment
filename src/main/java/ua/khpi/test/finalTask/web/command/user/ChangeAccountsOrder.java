...
public class ChangeAccountsOrder extends Command {

	private static final Logger LOG = LogManager.getLogger(ChangeAccountsOrder.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		session.setAttribute("accountsOrder", sortBy);

...
public class ActionsPageCommand extends Command {

	private static final Logger LOG = LogManager.getLogger(ActionsPageCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to actions page");
		
		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_ADMINS_ACTIONS);
	}

...
public class RedirectReplenishAccountCommand extends Command {
	
	private static final Logger LOG = LogManager.getLogger(RedirectReplenishAccountCommand.class);
	...
	public RequestProcessorInfo execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Redirecting to account replenish page");

		LOG.debug("Command finished");
		return new RequestProcessorInfo(ProcessorMode.FORWARD, Path.PAGE_REPLENISHMENT);
	}

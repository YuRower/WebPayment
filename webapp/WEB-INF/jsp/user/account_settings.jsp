		...
		<tr>
			<td class="content center">
				...
				<form action="controller" method="POST">
					<input type="hidden" name="command" value="changeAccountName" /> 
					<input type="hidden" name="accountId" value="${settingsAcc.id}" /> 
					<input name="name" placeholder="enter account name" required value = "${settingsAcc.name}"/> 
					<input type="submit" value="<fmt:message key="acc.set.chname"/>">
				</form> <br /> <c:choose>

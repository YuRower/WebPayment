		...
		<tr >
			<td class="content center">
				...
				<form id="login_form" action="controller" method="post">
					...
					<fieldset >
						<legend><fmt:message key="registration.text.newuser"/></legend>
						...
						<pre><fmt:message key="registration.info1"/><br/><fmt:message key="registration.info2"/><br/><fmt:message key="registration.info3"/><br/><fmt:message key="registration.info4"/>
						</pre>&#9;
					</fieldset><br/>
				</form><br/>
			</td>
